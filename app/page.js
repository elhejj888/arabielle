      ...
      <div className={`w-full py-6 transition-all duration-500 ease-in-out z-30 ${isScrolled ? 'bg-white/90 backdrop-blur-sm shadow-sm' : 'bg-transparent'}`}>
        <div className="flex flex-col md:flex-row items-center justify-between max-w-3xl mx-auto px-8">
          ...
          <div className="flex items-center space-x-6">
            <a href="https://www.instagram.com/maisonarabielle/" className="text-[#c1a173] hover:text-[#8c7361] transition-colors duration-300">
            ...
            <a href="https://www.tiktok.com/@maisonarabielle" className="text-[#c1a173] hover:text-[#8c7361] transition-colors duration-300">
